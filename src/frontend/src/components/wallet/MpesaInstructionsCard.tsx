...
export default function MpesaInstructionsCard({
  type,
        ...
        {type === "deposit" ? (
          <>
            ...
            <ol className="list-decimal list-inside mt-2 space-y-1">
              <li>
                Send funds via M-Pesa to{" "}
                <strong className="text-primary">{displayNumber}</strong>
              </li>
            ...
            <p className="mt-2 text-xs text-muted-foreground">
              Note: This is a manual process. Funds are not automatically
              charged.
            </p>
          </>
        ) : (
          <>
            ...
            <p className="mt-2">
              Enter your M-Pesa phone number. Admin will manually process your
              withdrawal request and send funds to your number.
            </p>
            <p className="mt-2 text-xs text-muted-foreground">
              Note: Withdrawals are processed manually and may take 1-2 business
              days.
            </p>
          </>
        )}
