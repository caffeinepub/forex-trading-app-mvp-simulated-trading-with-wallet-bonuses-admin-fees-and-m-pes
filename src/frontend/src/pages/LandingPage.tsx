  ...
  const features = [
    {
      ...
      description:
        "Practice forex trading with major currency pairs in a risk-free environment",
    },
    {
      icon: Wallet,
      title: "Wallet Management",
      description:
        "Deposit, withdraw, and manage your trading balance with M-Pesa support",
    },
    {
      icon: Shield,
        ...
        <div className="container relative py-24 md:py-36">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <Alert
                variant="destructive"
                className="border-destructive/50 bg-destructive/5 backdrop-blur-sm"
              >
                <AlertTriangle className="h-5 w-5" />
                <AlertDescription className="font-medium text-base">
                  <strong>Risk Disclaimer:</strong> Trading involves risk. This
                  is a simulated platform for educational purposes. Profits are
                  not guaranteed and past performance does not indicate future
                  results.
                </AlertDescription>
              </Alert>
        ...
        <div className="container">
          <div className="text-center mb-16 space-y-4">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              A complete simulated trading platform with wallet management,
              bonuses, and admin controls
            </p>
          </div>
          ...
          <Card className="relative overflow-hidden border-primary/20 shadow-premium-lg">
            ...
            <CardContent className="relative py-16 text-center space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Join {APP_NAME} today and experience simulated forex trading
